...
#' @param origin_name Specify the name (in quotes) of the origin location. You can always respecify this while invoking the create_flowMap() function.
#' @param destination_name Specify the name (in quotes) of the final destination. You can always respecify this while invoking the create_flowMap() function.
#' @param value_name
...
longTransform <- function(dataframe, origin_name, destination_name, value_name, value_columns){
  ...
  colnames(data_long)[2] <- origin_name
  colnames(data_long)[3] <- destination_name
