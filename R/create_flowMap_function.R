...
#'
#' This function creates a flow map from a dataframe. It will output a .bin file in your working directory for you to later upload to your specific EarthTime instance.
...
create_flowMap <-  function(dataframe, latitude_column, longitude_column, value_column, date_column, date_format = "%Y-%m-%d", rgb_color_scheme = "[255,0,0]"){
